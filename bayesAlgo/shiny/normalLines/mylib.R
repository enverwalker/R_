...
printSigma = function() {
  fluidRow(
    column(12, h3("Ковариационная матрица:"), style = "color: blue; text-align: center"),
    column(12, h3(textOutput("sigmaMess1")), style = "color: blue; text-align: center"),
    column(12, h3(textOutput("sigmaMess2")), style = "color: blue; text-align: center")
  )
}
